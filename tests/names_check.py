...
def main():
    ...
    # Адрес один на всё, что относится к претензии: сноска — под адресом
    # вердикта, исправленный абзац — под адресом блока.
    ids2 = ["s629.b0002", "s632.b0002"]
    _, shown2, claims2 = P.claims_text(
        "s629.b0002: связь выглядит необычно.\n"
        "s632.b0002: связь выглядит необычно.\n"
        "s632.b0002: термин вызывает сомнение.", {}, ids2)
    ok("претензии пронумерованы по блокам",
       claims2 == ["s629.b0002", "s632.b0002#1", "s632.b0002#2"], shown2)

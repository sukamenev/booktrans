...
def main():
    ...
    for who, want in (("Viktoria Viktorovna Zimenkova", "Zimenkova Viktoria Viktorovna"),
                      ...
                      # Фамилия — последнее слово с частицами: вторых имён на
                      # порядок больше, чем двойных фамилий без дефиса, и те
                      # по словам не узнать («Маркес Габриэль Гарсиа» — цена).
                      ("Габриэль Гарсиа Маркес", "Маркес Габриэль Гарсиа"),
                      ("Эдгар Аллан По", "По Эдгар Аллан"),
                      ("Эрих Мария Ремарк", "Ремарк Эрих Мария"),
                      ("Урсула Ле Гуин", "Ле Гуин Урсула"),
                      ...
                      ("J. R. R. Tolkien", "Tolkien J. R. R"),      # точка одна, от инициала
                      # Инициал впереди: фамилия последняя, а не «Виктор Хоффбранд».
                      ("А. Виктор Хоффбранд", "Хоффбранд А. Виктор"),
    ...
    # Карточка fb2 разбирает имя тем же правилом: библиотека сортирует по
    # фамилии, и «К. Маккрей (Wildbow)» в этой роли — ошибка.
    ok("карточка: инициал впереди", O.author_parts("А. Виктор Хоффбранд") == ("А. Виктор", "Хоффбранд", ""),
       O.author_parts("А. Виктор Хоффбранд"))
    ok("карточка: псевдоним отдельно",
       O.author_parts("Джон К. Маккрей (Wildbow)") == ("Джон К.", "Маккрей", "Wildbow"),
       O.author_parts("Джон К. Маккрей (Wildbow)"))
    ok("карточка: фамилия с частицей", O.author_parts("Антуан де Сент-Экзюпери") == ("Антуан", "де Сент-Экзюпери", ""),
       O.author_parts("Антуан де Сент-Экзюпери"))

    # Фамилию называет разведка: по словам не узнать ни двойную фамилию, ни
    # порядок «фамилия впереди». Чужое слово в этой роли не принимается.
    ok("фамилия от разведки: двойная",
       O.author_parts("Габриэль Гарсиа Маркес", "Гарсиа Маркес") == ("Габриэль", "Гарсиа Маркес", ""))
    ok("фамилия от разведки: стоит впереди", O.author_parts("Лю Цысинь", "Лю") == ("Цысинь", "Лю", ""))
    ok("фамилии нет в имени — работает правило по словам",
       O.author_parts("Эдгар Аллан По", "Кинг") == ("Эдгар Аллан", "По", ""))
    ok("имя файла с фамилией от разведки",
       B.out_name({"title": "Книга", "author": "Лю Цысинь", "author_surname": "Лю"}, "x") == "Лю Цысинь. Книга",
       B.out_name({"title": "Книга", "author": "Лю Цысинь", "author_surname": "Лю"}, "x"))

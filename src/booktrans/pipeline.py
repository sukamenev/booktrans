...
def scout_meta(work, to=""):
    ...
    # Справочник пишется на целевом языке, и заголовок раздела — тоже:
    # «PUBLICATION DATA», «DATOS DE PUBLICACIÓN». Списком их не перечислить,
    # а без выходных данных книга выходит под именем файла — с непереведённым
    # словом в заглавии и без автора. Выходные данные всегда идут первыми,
    # поэтому берём первый раздел, как бы он ни назывался.

...
def _shrink(part, want, keep, who, system, retries, log):
    ...
    ask = (
        ...
        "Первую ячейку каждой строки таблицы оставить дословно, вместе с "
        "оформлением: по ней сверяется, что ни одно имя и ни один термин не "
        "пропали. Ужимать в строке можно всё остальное.\n\n"
        "Заголовок раздела сохранить, новых не заводить, порядок строк не "
        "менять. Ничего не "

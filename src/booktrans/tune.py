...
# Строка, отбитая пустотой сверху и снизу, — заголовок: у pdf и txt другой
# приметы нет. Но так же выглядит и вёрстка в разрядку, а тогда таких строк
# сотни, и книга рассыпается на сотни глав. Много их — примета не работает,
# и лучше не размечать вовсе.
SPACED_MAX = 50

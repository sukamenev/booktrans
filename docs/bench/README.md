...
переводится и судится **три раза** (`--bench-runs`), в отчёт идёт медиана:
у средних моделей два перевода одного текста расходятся на 10–20 баллов,
у сильных на 3–7, и один прогон их не ранжирует.
...
отчёт `benchmark-en-ru-<…>.md`: первая строка — медиана, дальше версия
...
проваленные точки с причинами и штрафы прогона, ближайшего к медиане, и
...
Версия теста — в ключе (`booktrans-bench-key 1.3`) и в отчёте; любое

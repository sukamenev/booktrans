...
клички, norm — норма языка, adap — адаптация (с 1.4.0), note — сноски,
reg — регистр и откровенность; penalty — штрафы суммой. Методика — в
[README.md](README.md).

## Бенчмарк качества перевода en → ru, версия 1.4.0 — один прогон

Проверочные прогоны нового ключа: по одному переводу на модель, судья GPT-6
Sol. Очки областей — с весами (максимум 250), итог нормирован к 100.

| date | translator | score | runs | attempts | acc | full | calq | lex | style | verse | cons | gend | name | norm | adap | note | reg | penalty | booktrans | test | judge |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
